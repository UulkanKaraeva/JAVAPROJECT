...
public class Main {
	...
	public static void main(String[] args) {
		...
		//substring(int beginIndex, int endIdex) - returns substring for given begin index and end index
		System.out.println(str.substring(2,6));
		
		//contains() - returns true or false after matching the sequence of char value
		System.out.println(str.contains("va"));
		
		//equal(Object another) - checks the equality of string with the given object
		System.out.println(str.equals("JavaScript"));
		
		//isEmpty() - checks if string is empty
		System.out.println(str.isEmpty());
		
		//concat(string str) - concatenated the specified string
